    ...
    <div>
      ...
      <div className="flex justify-center relative z-2">
        <div className="w-9/12 h-96 z-0">
          <Image src="/crafts.jpeg" className="object-cover w-full h-full" height={1920} width={1920}></Image>
          <div className="text-2xl flex justify-center absolute bottom-0">
      <h1 className="bg-secondary rounded-lg p-4  mr-5 ml-5 mb-5" >Welcome to Family Makers!</h1>
      ...
      <div className="flex flex-col md:items-end mr-20 items-center" >
        <span className="">
      ...
      <div className="flex justify-start md:flex-row flex-col items-center">
        <div className="w-96 h-96 ml-5 mr-5">
          <Image src="/kid-math.jpeg" className="h-full object-cover w-full" height={1920} width={1920}/>
        </div>
